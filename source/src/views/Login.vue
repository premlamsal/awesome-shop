  ...
  <b-col>
    <div class="login mt-5">
      ...
      <b-form @submit.stop.prevent>
        ...
        <b-input v-model="user.email" id="feedback-email" type="email" placeholder="Enter email" class="mt-4"></b-input>
        ...
        <b-input v-model="user.password" id="feedback-password" type="password" placeholder="Enter password" class="mt-4"></b-input>
        <div class="error-block">
        ...
        <b-button variant="danger" class="mt-2 mb-2" @click="login" v-if="showLoginBtn" style="width:100%">
