        ...
        <b-col>
          <div class="CheckOut" v-if="isLoading === false">
              ...
              <div class="pay-box-outside">
                <div class="payment-img-holder">
                  <form :action="esewa_path" method="POST">
                    <input
                      v-bind:value="esewa_params.tAmt"
                      name="tAmt"
                      type="hidden"
                    />
                    <input
                      v-bind:value="esewa_params.amt"
                      name="amt"
                      type="hidden"
                    />
                    <input
                      v-bind:value="esewa_params.txAmt"
                      name="txAmt"
                      type="hidden"
                    />
                    <input
                      v-bind:value="esewa_params.psc"
                      name="psc"
                      type="hidden"
                    />
                    <input
                      v-bind:value="esewa_params.pdc"
                      name="pdc"
                      type="hidden"
                    />
                    <input
                      v-bind:value="esewa_params.scd_merchant"
                      name="scd"
                      type="hidden"
                    />
                    <input
                      v-bind:value="esewa_params.product_id"
                      name="pid"
                      type="hidden"
                    />
                    <input
            ...
            <div class="cart-info-box">
              ...
              <p>
                Your account details will be used for shipping. Please verify
...
export default {
  ...
  methods: {
    ...
    saveCartToOrder(){
       this.$http
        .post("https://eshop.test/api/frontend/create-order", this.getCartItems)
        .then((response)=>{
          ...
          this.khaltiConfig.productName =
            "productName" + response.data.product_id;

          this.khaltiConfig.productUrl =
            "http://eshop.test/" + response.data.product_id;
          ...
          this.esewa_params.product_id = response.data.product_id;
    ...
    verifyKhalti(payload) {
      ...
      this.$http
        .post("https://eshop.test/api/frontend/verify/khalti", formData)
        .then((response) => {
