  ...
  <div class="navbar-custom">
    ...
    <div class="container">
      <div class="menu-item" v-for="category in categories" :key="category.id">
        <div class="dropdown-custom" v-if="category.childs.length!=0">
          <button class="dropbtn-custom" @click="fromCatMenu(category.slug)">
            {{category.name}}
        ...
        <h2>{{category.title}}</h2>
            ...
            <div class="has-sub-menu">
              <SubCategory v-bind:childs="category.childs" />
            </div>
          </div>
        </div>
